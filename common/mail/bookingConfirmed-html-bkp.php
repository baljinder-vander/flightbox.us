	...
	<tbody style="display: inline-block; width: 100%;">
		...
		<tr style="display: inline-block; width: 100%;">
			...
			<td style= "display: inline-block; width: 100%; text-align: center;">
				...
				<h3 style="font-family: khand; font-weight: Medium; font-size: 28px; color: #ffffff; margin: 15px auto ; line-height: 39px; width: 100%; ">Your Flight Box reservation <br>has been confirmed.</h3>
		...
		<tr>
			...
			<td class="first-portion" style="width: 48%; display:inline-block; font-size: 17px; font-family: Roboto Condensed; font-weight; Normal; color: #ffffff;">

				<h6  style="font-family: khand; font-weight: Medium; font-size: 24px; color: #ffffff; margin: 0px 0 ;">Your Gear</h6>
			...
			<td class="first-portion" style="width: 48%; display:inline-block; vertical-align: top; font-size: 17px; font-family: Roboto Condensed; font-weight; Normal; color: #ffffff;">

				<h6 style="font-family: khand; font-weight: Medium; font-size: 24px; color: #ffffff; margin: 0px 0 ;">Your Total</h6>
		...
		<tr>
			...
			<td class="trip-sec" style="width: 100%; display:inline-block; vertical-align: top; font-size: 17px; font-family: Roboto Condensed; font-weight; Normal; color: #ffffff;">
		...
		<tr>
			...
			<td style="text-align: center; ">
				...
				<span style="font-family: khand; font-weight: Normal; font-size: 17px; color: #ffffff; margin: 30px 0 20px; display: inline-block; width: 100%; line-height: 34px;">Your Flight Box has been reserved and will be <br>waiting in your room upon your arrival.</span>
		...
		<tr>
			...
			<td style="margin-bottom: 10px; display: inline-block; font-size: 18px; font-family: khand; font-weight; Medium; color: #ffffff;">

				<img src="<?php echo Yii::$app->params['frontend_images_path']; ?>images/ntc.jpg" alt="" style="width: 60px; height: auto;">

				<p style="display: inline-block; vertical-align: top; font-size: 18px; font-family: khand; font-weight: Medium; color: #ffffff; width: calc(100% - 80px); padding-left: 15px; vertical-align: top; margin-top: 0;">Check out the Nike Training Club app for workout routines and inspiration.</p>
		...
		<tr>
			...
			<td style="margin-bottom: 10px; display: inline-block; font-size: 18px; font-family: khand; font-weight: Medium; color: #ffffff;">
				...
				<p style="display: inline-block; vertical-align: top; font-size: 18px; font-family: khand; font-weight: Medium; color: #ffffff; width: calc(100% - 80px); padding-left: 15px; vertical-align: top; margin-top: 0;">Listen to Nike on Spotify while you work out.</p>
		...
		<tr>
			...
			<td style="font-size: 18px; font-family: khand; font-weight: Medium; color: #ffffff;">

				<img src="<?php echo Yii::$app->params['frontend_images_path']; ?>images/ntc2.jpg" alt="" style="width: 60px; height: auto;">

				<p style="display: inline-block; vertical-align: top; font-size: 18px; font-family: khand; font-weight: Medium; color: #ffffff; width: calc(100% - 80px); padding-left: 15px; vertical-align: top; margin-top: 0;">Tune in to Nike’s “Trained” podcast.</p>
		...
		<tr>
			...
			<td class="all-txt" style="text-align: center; color: #ffffff; font-size: 14px; font-family: Roboto Condensed; font-weight: Normal;">

				<p style="color: #ffffff; font-size: 14px; font-family: Roboto Condensed; font-weight: Normal; margin-top: 30px; line-height: 22px;">Please contact support@goflightbox.com should you need to change or cancel your reservation. Cancellations within 24 hours of your scheduled arrival time will be charged the reservation fee, but will be refunded the total daily rental fee amount.</p>
