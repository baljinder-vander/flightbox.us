	...
	<tbody style="display: inline-block; width: 100%;">
		...
		<tr style="display: inline-block; width: 100%;">
			<td style= "display: inline-block; width: 100%; text-align: center;">
				<h3 style="font-family: khand,Arial,Helvetica,sans-serif; font-weight: Medium; font-size: 28px; color: #ffffff; margin: 15px auto ; line-height: 39px; width: 100%; ">Customer's Flight Box reservation <br>has been confirmed.</h3>
			</td>
		</tr>
		<tr style="display: inline-block; width: 100%;">
			<td style="display: inline-block; width: 100%; text-align: center;">
		...
		<!--<tr  style="width: 100%; display:inline-block;  color: #ffffff;font-family: Roboto Condensed,Arial,Helvetica,sans-serif;">
			<td class="trip-sec"  width="600" style="width: 100%; display:inline-block; vertical-align: top; font-size: 17px; font-family: Roboto Condensed,Arial,Helvetica,sans-serif; font-weight; Normal; color: #ffffff;">
				<h6 style="font-family: khand; font-weight: Medium; font-size: 24px; color: #ffffff; margin: 30px 0 0;">Customer's Email: <?php echo $cust_email; ?></h6>
				</td>
		...
		<tr style="display:inline-block;  color: #ffffff;width: 100%;vertical-align: sub;font-family: Roboto Condensed,Arial,Helvetica,sans-serif;">
			...
			<td class="first-portion" width="280" style="width: 48%; display:inline-block; font-size: 17px; font-family: Roboto Condensed,Arial,Helvetica,sans-serif; font-weight; Normal; color: #ffffff;">
				<h6  style="font-family: khand,Arial,Helvetica,sans-serif; font-weight: Medium; font-size: 24px; color: #ffffff; margin: 0px 0 ;">Gear Details</h6>
			...
			<td class="first-portion"  width="280" style="width: 48%; display:inline-block; vertical-align: top; font-size: 17px; font-family: Roboto Condensed,Arial,Helvetica,sans-serif; font-weight; Normal; color: #ffffff;">
				<h6 style="font-family: khand,Arial,Helvetica,sans-serif; font-weight: Medium; font-size: 24px; color: #ffffff; margin: 0px 0 ;">Customer Details</h6>
				<p style="font-size: 17px; font-family: Roboto Condensed; font-weight; Normal; color: #ffffff; margin: 5px 0;">First Name: <?php echo $orderData['firstname']; ?></p>
				<p style="font-size: 17px; font-family: Roboto Condensed; font-weight; Normal; color: #ffffff; margin: 5px 0;">Last Name: <?php echo $orderData['lastname']; ?></p>
		...
		<tr  style="width: 100%; display:inline-block;  color: #ffffff;font-family: Roboto Condensed,Arial,Helvetica,sans-serif;">
			<td class="trip-sec"  width="600" style="width: 100%; display:inline-block; vertical-align: top; font-size: 17px; font-family: Roboto Condensed,Arial,Helvetica,sans-serif; font-weight; Normal; color: #ffffff;">
				<h6 style="font-family: khand; font-weight: Medium; font-size: 24px; color: #ffffff; margin: 30px 0 0;">Trip Details</h6>
